    ...
    <div className="section__content aboutMe__content">
      ...
      <div className="aboutMe__flex">
        ...
        <div className="aboutMe__inf">
          ...
          <p className="section__subheading section__subheading_aboutMe">Фронтенд-разработчик, 28
            лет</p>
        ...
        <ul aria-label="Портфолио" className="list portfolio-list">
          <li className="portfolio-list__item">
            <a className="link portfolio-list__link" href="https://github.com/AntonovkaE/react-mesto-api-full">Статичный
              сайт</a>
          </li>
          <li className="portfolio-list__item">
            <a className="link portfolio-list__link" href="https://antonovkae.github.io/russian-travel/index.html">Адаптивный
              сайт</a>
          </li>
          <li className="portfolio-list__item">
            <a className="link portfolio-list__link" href="https://github.com/AntonovkaE/how-to-learn">Одностраничное
              приложение</a>
          </li>
        </ul>
      </div>
