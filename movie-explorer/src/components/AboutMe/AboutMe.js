      ...
      <div className="aboutMe__flex">
        ...
        <ul aria-label="Портфолио" className="list portfolio-list">
          <li className="portfolio-list__item">
            <a className="link portfolio-list__link"
               href="https://github.com/AntonovkaE/react-mesto-api-full">Статичный
              сайт</a>
            <div className="portfolio-list__icon">↗</div>
          </li>
          <li className="portfolio-list__item">
            <a className="link portfolio-list__link"
               href="https://antonovkae.github.io/russian-travel/index.html">Адаптивный
              сайт</a>
            <div className="portfolio-list__icon">↗</div>
          </li>
          <li className="portfolio-list__item">
            <a className="link portfolio-list__link"
               href="https://github.com/AntonovkaE/how-to-learn">Одностраничное
              приложение</a>
            <div className="portfolio-list__icon">↗</div>
          </li>
        </ul>
